import { Box, Button, Flex, Icon, Heading, Table, Thead, Tr, Td, Th, Text, Checkbox, Tbody, useBreakpointValue } from "@chakra-ui/react"
                    ...
                    <Table colorScheme="whiteAlpha">
                        ...
                        <Tbody>
                            <Tr>
                                ...
                                <Td>
                                    <Box>
                                        <Text fontWeight="bold">Vinicius Rosa</Text>
                                        <Text fontSize="sm" color="gray.300">teste@teste.com</Text>
                                    </Box>
                                </Td>
                                {isWideVersion && <Td>Hoje</Td>}
                                <Td>
